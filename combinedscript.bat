echo "Made by Ellie, Adam and Peter"
@ECHO OFF

Set /p ntrights=”Has ntrights.exe been installed (yes/no)?”
If %ntrights% == no (
	Set urlntrights=”https://winaero.com/downloads/ntrights.zip”
	Start iexplore.exe %urlntrights%
)
Set /p installation=”Type "yes" if the ntrights.exe file has been installed.”
If %installation% == yes (
	Set urlntrights=”https://winaero.com/downloads/ntrights.zip”
	Start iexplore.exe %urlntrights%
...
wmic product where "description='QuickTime'" uninstall
wmic product where "description='CCleaner'" uninstall
wmic product where "description='Ophcrack'" uninstall
wmic product where "description='netcat'" uninstall
wmic product where "description='TeamViewer'" uninstall
wmic product where "description='Wireshark'" uninstall
wmic product where "description='Real Player'" uninstall
wmic product where "description='PC Fixer Pro'" uninstall
wmic product where "description='Vuze Bittorrent Client'" uninstall
...
::Windows Updates
rem Installing Windows Updates
...
If %firefoxq% == no (
    ...
    https://winaero.com/download-ntrights/#google_vignette
)
